        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <textarea v-model="templateForm.content" class="form-control font-monospace" rows="15"></textarea>
            </div>
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row g-3 mb-3">
              <div class="col-md-8">
                <label class="form-label">{{ t('configs_page.variables_json') }}</label>
                <textarea v-model="moduleForm.variables" class="form-control font-monospace" rows="5"></textarea>
              </div>
              <div class="col-md-4">
            ...
            <div class="mb-3">
              ...
              <textarea v-model="moduleForm.content" class="form-control font-monospace" rows="16"></textarea>
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{ t('cancel') }}</button>
