  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("../views/AggregationGroups.vue"),
      },
      {
        path: "output-targets",
        name: "OutputTargets",
        component: () => import("../views/OutputTargets.vue"),
      },
      {
        path: "pipelines",
        name: "Pipelines",
      ...
      },
      {
        path: "deploys",
        name: "Deploys",
        component: () => import("../views/Deploys.vue"),
      },
      {
        path: "bootstrap",
        name: "BootstrapHosts",
        component: () => import("../views/BootstrapHosts.vue"),
      ...
      },
      {
        path: "agent-policies",
        name: "AgentPolicies",
        component: () => import("../views/AgentPolicies.vue"),
      },
      {
        path: "agent-access-keys",
        name: "AgentAccessKeys",
        component: () => import("../views/AgentAccessKeys.vue"),
        meta: { permission: { resource: "agent_keys", action: "read" } },
      },
      {
        path: "ai-settings",
        name: "AISettings",
        component: () => import("../views/AISettings.vue"),
        meta: { permission: { resource: "ai_settings", action: "read" } },
      },
      {
        path: "users",
        name: "Users",
...
router.beforeEach(async (to) => {
  ...
  if (
    ...
    !isAdmin &&
    !auth.hasPermission(permission.resource, permission.action)
  ) {
    return "/";
  }
});
